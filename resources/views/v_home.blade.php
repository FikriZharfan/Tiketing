...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0"  target="_blank">
        ...
        <span class="ms-1 font-weight-bold text-white"> Customer Service </span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="{{url('dasboard')}}">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/tiket')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <form  id="logout-form" action="{{ route('logout') }}" method="POST">
          @csrf
              <button type="submit" href="#" class="btn btn-primary text-center me-2 d-flex align-items-center justify-content-center ">Logout</button>
        </form>
      </div>
    </div>
  </aside>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              ...
              <i class="fa fa-heart"></i> by
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Fikri Zharfan</a>
                for a better web.
              </div>
            </div>
          </div>
  ...
  {{-- js tild --}}
  <script type="text/javascript" src="{{asset('admin/assets/js/tilt.min.js')}}"></script>
  <!-- Github buttons -->
